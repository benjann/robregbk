...
For symmetric $F$, the influence function of $\stsc{HL}$ is given as
                                                                                ...
                                                                                clearer. Furthermore, in the numerator it should 
                                                                                be $F(x-\stsc{HL}(F))$, not $F(x-\mu)$, I think (in 
                                                                                Staudte/Sheather 1990:121 $\mu$ is used, but 
                                                                                they define $\mu$ as the median of $(X+Y)/2$).}
\[
...
is not smooth. To tackle this problem, \citet{brys:etal:2004} propose to
...
\alert{
\begin{stlog}
\input{dof/3/6.log.tex}
\end{stlog}
}

\section{Robust tests of normality}

\alert{[Need to revise this section to include all normality tests computed by
\stcmd{robstat}. Also need to include details on the Wald-style variant of the tests.]}
